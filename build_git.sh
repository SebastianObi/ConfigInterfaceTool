...
BRANCH="main"
ORIGIN="git@github.com:SebastianObi/ConfigInterfaceTool.git"
FILES_ADD=(".")
FILES_REMOVE=(".git/*" "backup/*auto_backup*" "backup/*user_backup*" "cache/*.cfg" "test/*" "tmp/*" "config.cfg" "config_auth.cfg")
